...
void symbolicEquations::generateContactPotentialPiecewiseFunctions1() {
...
void symbolicEquations::generateContactPotentialPiecewiseFunctions2() {
    // Generate Point to Point
    DenseMatrix x1s({x1s_x, x1s_y, x1s_z});
    DenseMatrix x1e({x1e_x, x1e_y, x1e_z});
    DenseMatrix x2s({x2s_x, x2s_y, x2s_z});
    ...
    RCP<const Basic> E_p2p = pow(sub(h2, dist_p2p), 2);
    DenseMatrix E_p2p_potential{{E_p2p}};
    ...
    E_p2p_pen_gradient_func.init(func_p2p_inputs, E_p2p_gradient.as_vec_basic(), symbolic_cse, opt_level);
    E_p2p_pen_hessian_func.init(func_p2p_inputs, E_p2p_hessian.as_vec_basic(), symbolic_cse, opt_level);
    ...
    RCP<const Basic> E_e2p = pow(sub(h2, dist_e2p), 2);
    ...
    E_e2p_pen_gradient_func.init(func_e2p_inputs, E_e2p_gradient.as_vec_basic(), symbolic_cse, opt_level);
    E_e2p_pen_hessian_func.init(func_e2p_inputs, E_e2p_hessian.as_vec_basic(), symbolic_cse, opt_level);
    ...
    RCP<const Basic> E_e2e = pow(sub(h2, dist_e2e), 2);
    DenseMatrix E_e2e_potential{{E_e2e}};
    ...
    E_e2e_pen_gradient_func.init(func_e2e_inputs, E_e2e_gradient.as_vec_basic(), symbolic_cse, opt_level);
    E_e2e_pen_hessian_func.init(func_e2e_inputs, E_e2e_hessian.as_vec_basic(), symbolic_cse, opt_level);
}


void symbolicEquations::generateFrictionJacobianPiecewiseFunctions1() {
...
void symbolicEquations::generateFrictionJacobianPiecewiseFunctions2() {
    DenseMatrix nodes{{x1s_x, x1s_y, x1s_z,
                       x1e_x, x1e_y, x1e_z,
                       x2s_x, x2s_y, x2s_z,
                       x2e_x, x2e_y, x2e_z}};
    ...
    friction_partials_gamma1_dfr_dx_func.init(ffr_input, friction_partial_dfr_dx.as_vec_basic(), symbolic_cse, opt_level);
    friction_partials_gamma1_dfr_dfc_func.init(ffr_input, friction_partial_dfr_dfc.as_vec_basic(), symbolic_cse, opt_level);
}


void symbolicEquations::generateFrictionJacobianPiecewiseFunctions3() {
    DenseMatrix nodes{{x1s_x, x1s_y, x1s_z,
                       x1e_x, x1e_y, x1e_z,
                       x2s_x, x2s_y, x2s_z,
                       x2e_x, x2e_y, x2e_z}};
